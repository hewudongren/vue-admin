...
//   },
  ...
  //主页面 
  {
    ...
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/Bresources/index')
  },
  {
    path: '/bresources/resource',
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/resource/index')
  },
  {
    path: '/bresources/parameters',
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/parameters/index')
  },
  {
    path: '/bresources/parameters/edit/:id',
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/parameters/edit')
  },
  {
    path: '/bresources/parameters/add/:id',
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/parameters/add')
  },
  {
    path: '/bresources/information',
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/information/index')
  },
  {
    path: '/bresources/picture',
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/picture/index')
  },
  {
    path: '/bresources/process',
    component: () => import(/*webpackChunkName: "process_index"*/'./modules/Bresources/process/index')
  },
  {
    path: '/bresources/process/edit/:id',
    component: () => import(/*webpackChunkName: "svc_index"*/'./modules/Bresources/process/edit')
  },
  // {
