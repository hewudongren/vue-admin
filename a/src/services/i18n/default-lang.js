...
export default _.extend({
  ...
  'platform.common.noData': '',
  'platform.app_app.creatorId': '',
  'platform.common.detail': '',
  'platform.svc.gitRepo': '',
  'platform.common.userName': '',
  'platform.common.password':'',
  'platform.user_setting.name': '',
  'platform.user_setting.modifyAvatar':'',
  'platform.common.modify':'',
  'platform.user_setting.oldPassword':'',
  'platform.user_setting.newPassword':'',
  'platform.user_setting.confirmPassword':'',
  'platform.common.setted': ''
