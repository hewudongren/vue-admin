<template>
  <el-form ref="jwForm" class="app-base-wrapper" :model="entity" :rules="rules" label-position="right" label-width="100px">
    ...
    <el-form-item :label="appLang['platform.app_app.category']">
    ...
    <el-form-item :label="appLang['platform.svc.gitRepo']">
      <el-input v-model="entity.gitRepo" :placeholder="appLang['platform.svc.gitRepo']"></el-input>
    </el-form-item> 
    ...
    <el-form-item :label="appLang['platform.common.desc']">
      <el-input type="textarea" :maxlength="descMaxLength" v-model="entity.description" :placeholder="appLang['platform.common.desc']"></el-input>
    </el-form-item>
  </el-form>
</template>
