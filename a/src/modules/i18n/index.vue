  ...
  <div class="panel i18n-panel">
    ...
    <div class="i18n-wrapper" v-loading="loading">
      ...
      <div class="panel-right">
        <jw-table-control ref="tableControlRef" :buttons="getTableConfig()" @on-header-button="onAddition" @on-input-change="onChangeHandler"/>
        <jw-table
  ...
  methods: {
    ...
    onTreeClick(group) {
      ...
      if(this.selectedGroup !== group) {
        this.$refs.tableControlRef.emptyInputs();
