<template>
   <!-- 待审单列表页面 -->
    <div class="reviewList">
        <!--确认国家  -->
        <el-row>
            <el-button size="medium">马来待确认(20)</el-button>
            <el-button type="primary" size="medium">泰国待确认(20)</el-button>
            <el-button type="success" size="medium">新加坡待确认(20)</el-button>
            <el-button type="info" size="medium">印尼待确认(20)</el-button>
            <el-button type="warning" size="medium">阿联酋待确认(20)</el-button>
            <el-button type="danger" size="medium">台湾待确认(20)</el-button>
        </el-row>
        <!-- 隔离带 -->
        <div style="height:10px;"></div>
        <!-- 问题单 -->
         <el-row>
            <el-button size="medium">马来问题单(20)</el-button>
            <el-button type="primary" size="medium">泰国问题单(0)</el-button>
            <el-button type="success" size="medium">新加坡问题单(2)</el-button>
            <el-button type="info" size="medium">印尼问题单(2)</el-button>
            <el-button type="warning" size="medium">阿联酋问题单(0)</el-button>
            <el-button type="danger" size="medium">台湾问题单(0)</el-button>
        </el-row>
        <!-- 隔离带 -->
        <div style="height:10px;"></div>
        <!-- 搜索区 -->
