<template>
    <div class="brandList">
        <!-- 品牌操作 -->
        <div>
            <el-button type="primary" @click="append" class="mgb10">添加品牌</el-button>
        </div>
        <!-- 品牌列表 -->
        <div ref="ta" class="list">
         <el-table
            ...
            border
            style="width: 100%">
            <el-table-column prop="cat_name" label="类目" width="100">
            ...
            <el-table-column prop="logo" label="logo" >
                 <template slot-scope="scope">
                     <img v-if="scope.row.logo" :src="'http://img.orkotech.com/'+scope.row.logo" class="avatar">
                </template>
            </el-table-column>
  ...
  export default {
    ...
    data() {
     ...
     methods:{
        //请求数据
        getData(){
             this.$axios.get("/brands",this.searchobj).then(res=>{
