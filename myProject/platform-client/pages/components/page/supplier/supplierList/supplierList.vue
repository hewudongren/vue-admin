<template>
    <div class="supplierList">
        <!-- 供应商操作 -->
        <el-button type="primary" @click="append" class="mgb10">添加供应商</el-button>
        <!-- 供应商列表 -->
        <div ref="ta" class="list">
         <el-table
            ...
            <el-table-column prop="link_name" label="联系人" >
             ...
             <el-table-column prop="link_phone" label="电话" >
  ...
  export default {
    ...
    data() {
     ...
     methods:{
        //请求数据
        getData(){
             this.$axios.get("/suppliers",this.searchobj).then(res=>{
