    ...
    <div class="BuyerList">
        ...
        <div ref="ta" class="list">
            <el-table
                ...
                border
                style="width: 100%">
                <el-table-column prop="ref" label="采购单" width="100">
                
                </el-table-column>
                <el-table-column prop="supplier_platform" label="平台" width="100">
                
                </el-table-column>
                <el-table-column prop="supplier_ref" label="平台单号" >
                ...
                <el-table-column prop="action_time" label="采购时间" >
                
                </el-table-column>
                <el-table-column prop="action_user_id" label="采购人" >
                
                </el-table-column>
                <el-table-column prop="status" label="状态" width="160">
                    <template slot-scope="scope">
                         <el-tag type="danger" v-if="scope.row.status==1">待审核</el-tag>
                        <el-tag type="danger" v-if="scope.row.status==2">已审核 </el-tag>
                        <el-tag type="danger" v-if="scope.row.status==3">待付款</el-tag>
                         <el-tag type="danger" v-if="scope.row.status==4">已付款</el-tag>
                    </template>
                </el-table-column>
  ...
  export default {
    ...
    data() {
     ...
     methods:{
        //请求数据
        getData(){
             this.$axios.get("/purchases",this.searchobj).then(res=>{
