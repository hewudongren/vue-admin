<template>
    <div class="brandList">
        <!-- 评论操作 -->
        <div class="mgb10">
            <el-button type="primary" @click="add">添加评论</el-button>
        </div>
        <!-- 评论列表 -->
        <div ref="ta" class="list">
         <el-table
            ...
            border
            style="width: 100%">
            <el-table-column prop="color" label="ID" width="50">
               
            </el-table-column>
            <el-table-column prop="size" label="产品ID" width="50">
               
            </el-table-column>
            <el-table-column prop="SKU" label="姓名" >
               
            </el-table-column>
            <el-table-column prop="SKU" label="电话" >
               
            </el-table-column>
             <el-table-column prop="SKU" label="评分" >
