<template>
    <div class="SKUSet">
        ...
        <div class="add">
            ...
            <span>产品SPU:{{SPU}}</span>
            <el-button type="primary"  class="mgb10"  @click="appendSKU">添加变体SKU</el-button>
        </div>
        <!-- SKU列表 -->
         ...
         <el-table
            ...
            <el-table-column prop="SKU" label="SKU" >
             ...
             <el-table-column  label="组合">
                <template slot-scope="scope">
                    <span>SKU:</span><i>{{scope.row.group.SKU}}</i>
                    <span>数量:</span><i>{{scope.row.group.count}}</i>
                </template>
            </el-table-column>
         
              <el-table-column  label="动作" width="160" align="center">
                <template slot-scope="scope">
                    <el-button type="warning" @click="edit(scope)" >修改</el-button>
                    <el-button type="danger" @click="edit(scope)" >删除</el-button>
                </template>
            </el-table-column>
        </el-table>
        </div>
